    ...
    function i(e, i) {
        ...
        if ("area" === n) {
            var a, o = e.parentNode,
                r = o.name;
            return e.href && r && "map" === o.nodeName.toLowerCase() ? (a = t("img[usemap=#" + r + "]")[0], !!a && s(a)) : !1
        }
...
function(t, e) {
    ...
    t.widget = function(e, i, s) {
        var n, a = e.split(".")[0];
        e = e.split(".")[1], n = a + "-" + e, s || (s = i, i = t.Widget), t.expr[":"][n] = function(i) {
            return !!t.data(i, e)
        ...
        _trigger: function(e, i, s) {
            ...
            return this.element.trigger(i, s), !(t.isFunction(o) && o.call(this.element[0], i, s) === !1 || i.isDefaultPrevented())
        }
    }
}(jQuery),
function(t, e) {
    ...
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        _generatePosition: function(e) {
            ...
            if (this.originalPosition) {
                ...
                if (i.grid) {
                    ...
                    o = r && (h - this.offset.click.top < r[1] || h - this.offset.click.top > r[3]) ? h - this.offset.click.top < r[1] ? h + i.grid[1] : h - i.grid[1] : h;
        ...
        drag: function(e, i) {
            var s = t(this).data("draggable"),
                n = s.options,
                a = !1;
            s.scrollParent[0] != document && "HTML" != s.scrollParent[0].tagName ? (n.axis && "x" == n.axis || (s.overflowOffset.top + s.scrollParent[0].offsetHeight - e.pageY < n.scrollSensitivity ? s.scrollParent[0].scrollTop = a = s.scrollParent[0].scrollTop + n.scrollSpeed : e.pageY - s.overflowOffset.top < n.scrollSensitivity && (s.scrollParent[0].scrollTop = a = s.scrollParent[0].scrollTop - n.scrollSpeed)), n.axis && "y" == n.axis || (s.overflowOffset.left + s.scrollParent[0].offsetWidth - e.pageX < n.scrollSensitivity ? s.scrollParent[0].scrollLeft = a = s.scrollParent[0].scrollLeft + n.scrollSpeed : e.pageX - s.overflowOffset.left < n.scrollSensitivity && (s.scrollParent[0].scrollLeft = a = s.scrollParent[0].scrollLeft - n.scrollSpeed))) : (n.axis && "x" == n.axis || (e.pageY - t(document).scrollTop() < n.scrollSensitivity ? a = t(document).scrollTop(t(document).scrollTop() - n.scrollSpeed) : t(window).height() - (e.pageY - t(document).scrollTop()) < n.scrollSensitivity && (a = t(document).scrollTop(t(document).scrollTop() + n.scrollSpeed))), n.axis && "y" == n.axis || (e.pageX - t(document).scrollLeft() < n.scrollSensitivity ? a = t(document).scrollLeft(t(document).scrollLeft() - n.scrollSpeed) : t(window).width() - (e.pageX - t(document).scrollLeft()) < n.scrollSensitivity && (a = t(document).scrollLeft(t(document).scrollLeft() + n.scrollSpeed)))), a !== !1 && t.ui.ddmanager && !n.dropBehaviour && t.ui.ddmanager.prepareOffsets(s, e)
        }
...
function(t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStart: function(e) {
            ...
            return t("body").css("cursor", "auto" == l ? this.axis + "-resize" : l), a.addClass("ui-resizable-resizing"), this._propagate("start", e), !0
        },
        ...
        _respectSize: function(t, e) {
            ...
            r && (t.width = i.minWidth), l && (t.height = i.minHeight), a && (t.width = i.maxWidth), o && (t.height = i.maxHeight);
            var h = this.originalPosition.left + this.originalSize.width,
                c = this.position.top + this.size.height,
                u = /sw|nw|w/.test(n),
                d = /nw|ne|n/.test(n);
            r && u && (t.left = h - i.minWidth), a && u && (t.left = h - i.maxWidth), l && d && (t.top = c - i.minHeight), o && d && (t.top = c - i.maxHeight);
        ...
        start: function(e, i) {
            ...
            "object" != typeof n.alsoResize || n.alsoResize.parentNode ? a(n.alsoResize) : n.alsoResize.length ? (n.alsoResize = n.alsoResize[0], a(n.alsoResize)) : t.each(n.alsoResize, function(t) {
                a(t)
            })
        },
        resize: function(e, i) {
        ...
        start: function(e, s) {
            var n = t(this).data("resizable"),
                ...
                o = n.element,
                r = a.containment,
                l = r instanceof t ? r.get(0) : /parent/.test(r) ? o.parent().get(0) : r;
            if (l)
        ...
        resize: function(e, i) {
            ...
            var h = Math.round((a.width - o.width) / (n.grid[0] || 1)) * (n.grid[0] || 1),
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseCapture: function(e, i) {
            ...
            t(e.target).parents().each(function() {
                return t.data(this, s.widgetName + "-item") == a ? (n = t(this), !1) : void 0
            });
            if (t.data(e.target, s.widgetName + "-item") == a && (n = t(e.target)), !n) return !1;
        ...
        _mouseStart: function(e, i, s) {
            ...
            if (this.currentContainer = this, this.refreshPositions(), this.helper = this._createHelper(e), this._cacheHelperProportions(), this._cacheMargins(), this.scrollParent = this.helper.scrollParent(), this.offset = this.currentItem.offset(), this.offset = {
                ...
                for (var o = this.containers.length - 1; o >= 0; o--) this.containers[o]._trigger("activate", e, a._uiHash(this));
        ...
        _mouseDrag: function(e) {
            ...
            for (var n = this.items.length - 1; n >= 0; n--) {
                ...
                if (r && a.instance === this.currentContainer && o != this.currentItem[0] && this.placeholder[1 == r ? "next" : "prev"]()[0] != o && !t.ui.contains(this.placeholder[0], o) && ("semi-dynamic" == this.options.type ? !t.ui.contains(this.element[0], o) : !0)) {
        ...
        _refreshItems: function(e) {
            ...
            for (var a = s.length - 1; a >= 0; a--)
                for (var h = s[a][1], c = s[a][0], r = 0, u = c.length; u > r; r++) {
                    var d = t(c[r]);
        ...
        _contactContainers: function(e) {
            ...
            if (i)
                ...
                for (var a = 1e4, o = null, r = this.positionAbs[this.containers[s].floating ? "left" : "top"], l = this.items.length - 1; l >= 0; l--)
                    if (t.ui.contains(this.containers[s].element[0], this.items[l].item[0])) {
                        ...
                        Math.abs(h - r) < a && (a = Math.abs(h - r), o = this.items[l], this.direction = h - r > 0 ? "down" : "up")
                    }
        ...
        t.effects.animateClass = function(e, i, s, r) {
            return t.isFunction(s) && (r = s, s = null), this.queue(function() {
                ...
                t.each(c, function(t, i) {
                    e[i] && h[i + "Class"](e[i])
                }), l = a(n.call(this)), h.attr("class", p), h.animate(o(d, l), {
                    queue: !1,
                    duration: i,
                    easing: s,
                    complete: function() {
                        t.each(c, function(t, i) {
                            e[i] && h[i + "Class"](e[i])
                        }), "object" == typeof h.attr("style") ? (h.attr("style").cssText = "", h.attr("style").cssText = u) : h.attr("style", u), r && r.apply(this, arguments), t.dequeue(this)
                    }
                })
            })
        }, t.fn.extend({
            ...
            toggleClass: function(i, s, n, a, o) {
                return "boolean" == typeof s || s === e ? n ? t.effects.animateClass.apply(this, [s ? {
                    ...
                    remove: i
                }, n, a, o]) : this._toggleClass(i, s) : t.effects.animateClass.apply(this, [{
                    toggle: i
                }, s, n, a])
            },
        ...
        t.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(t, e) {
            ...
            t.easing["easeIn" + e] = i, t.easing["easeOut" + e] = function(t) {
                ...
                return .5 > t ? i(2 * t) / 2 : i(-2 * t + 2) / -2 + 1
            }
        })
    }(jQuery),
    function(t, e) {
        t.effects.blind = function(e) {
            return this.queue(function() {
                ...
                var o = t.effects.createWrapper(i).css({
                    ...
                    l = "vertical" == a ? o.height() : o.width();
                "show" == n && o.css(r, 0);
                var h = {};
                h[r] = "show" == n ? l : 0, o.animate(h, e.duration, e.options.easing, function() {
    ...
    function(t, e) {
        t.effects.bounce = function(e) {
            return this.queue(function() {
                ...
                if ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -o : o), "hide" == n && (o /= 2 * r), "hide" != n && r--, "show" == n) {
                    var u = {
                        opacity: 1
                    };
                    u[h] = ("pos" == c ? "+=" : "-=") + o, i.animate(u, l / 2, e.options.easing), o /= 2, r--
                }
                for (var d = 0; r > d; d++) {
                    var p = {},
                        f = {};
        ...
        t.effects.drop = function(e) {
            return this.queue(function() {
                ...
                var o = "up" == a || "down" == a ? "top" : "left",
                    r = "up" == a || "left" == a ? "pos" : "neg",
                    l = e.options.distance || ("top" == o ? i.outerHeight(!0) / 2 : i.outerWidth(!0) / 2);
                "show" == n && i.css("opacity", 0).css(o, "pos" == r ? -l : l);
                var h = {
                    opacity: "show" == n ? 1 : 0
                };
                h[o] = ("show" == n ? "pos" == r ? "+=" : "-=" : "pos" == r ? "-=" : "+=") + l, i.animate(h, {
                    queue: !1,
                    duration: e.duration,
                    easing: e.options.easing,
                    complete: function() {
        ...
        t.effects.fold = function(e) {
            return this.queue(function() {
                ...
                var l = t.effects.createWrapper(i).css({
                    ...
                    d = /([0-9]+)%/.exec(a);
                d && (a = parseInt(d[1], 10) / 100 * u["hide" == n ? 0 : 1]), "show" == n && l.css(o ? {
                    height: 0,
                    width: a
                } : {
                    height: a,
                ...
                var p = {},
                    f = {};
                p[c[0]] = "show" == n ? u[0] : a, f[c[1]] = "show" == n ? u[1] : 0, l.animate(p, r, e.options.easing).animate(f, r, e.options.easing, function() {
                    "hide" == n && i.hide(), t.effects.restore(i, s), t.effects.removeWrapper(i), e.callback && e.callback.apply(i[0], arguments), i.dequeue()
                })
            })
        }
        ...
        t.effects.pulsate = function(e) {
            return this.queue(function() {
                var i = t(this),
                    ...
                    o = i.is(":visible"),
                    r = 0;
                o || (i.css("opacity", 0).show(), r = 1), ("hide" == s && o || "show" == s && !o) && n--;
                for (var l = 0; n > l; l++) i.animate({
                    opacity: r
                }, a, e.options.easing), r = (r + 1) % 2;
                i.animate({
                    opacity: r
    ...
    function(t, e) {
        t.effects.puff = function(e) {
            ...
            return this.queue(function() {
                ...
                ("box" == u || "both" == u) && (g.from.y != g.to.y && (s = s.concat(r), i.from = t.effects.setTransition(i, r, g.from.y, i.from), i.to = t.effects.setTransition(i, r, g.to.y, i.to)), g.from.x != g.to.x && (s = s.concat(l), i.from = t.effects.setTransition(i, l, g.from.x, i.from),
        ...
        t.effects.shake = function(e) {
            return this.queue(function() {
                ...
                var l = "up" == n || "down" == n ? "top" : "left",
                    ...
                    u = {},
                    d = {};
                c[l] = ("pos" == h ? "-=" : "+=") + a, u[l] = ("pos" == h ? "+=" : "-=") + 2 * a, d[l] = ("pos" == h ? "-=" : "+=") + 2 * a, i.animate(c, r, e.options.easing);
                for (var p = 1; o > p; p++) i.animate(u, r, e.options.easing).animate(d, r, e.options.easing);
    ...
    function(t, e) {
        t.effects.slide = function(e) {
            return this.queue(function() {
                ...
                "show" == n && i.css(o, "pos" == r ? isNaN(l) ? "-" + l : -l : l);
                var h = {};
                h[o] = ("show" == n ? "pos" == r ? "+=" : "-=" : "pos" == r ? "-=" : "+=") + l, i.animate(h, {
                    queue: !1,
                    duration: e.duration,
                ...
                if (!s.disabled) {
                    if (!e.target) {
                        ...
                        var n = this.active.next(),
                            ...
                            o = this.active = t([]);
                        return void this._toggle(o, n, a)
                    }
                    var r = t(e.currentTarget || i),
                        l = r[0] === this.active[0];
                    if (s.active = s.collapsible && l ? !1 : this.headers.index(r), !(this.running || !s.collapsible && l)) {
                        var h = this.active,
                            o = r.next(),
                            n = this.active.next(),
                            a = {
            ...
            animations: {
                slide: function(e, i) {
                    ...
                    s = h[0].style.width, h.width(h.parent().width() - parseFloat(h.css("paddingLeft")) - parseFloat(h.css("paddingRight")) - (parseFloat(h.css("borderLeftWidth")) || 0) - (parseFloat(h.css("borderRightWidth")) || 0)), t.each(l, function(i, s) {
                        ...
                        step: function(t, i) {
                            "height" == i.prop && (a = i.end - i.start === 0 ? 0 : (i.now - i.start) / (i.end - i.start)), e.toShow[0].style[i.prop] = a * o[i.prop].value + o[i.prop].unit
                        },
                        duration: e.duration,
                        easing: e.easing,
                        complete: function() {
    ...
    function(t, e) {
        ...
        t.widget("ui.autocomplete", {
                ...
                this.isMultiLine = this.element.is("textarea"), this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({
                    ...
                    selected: function(t, e) {
                        var n = e.item.data("item.autocomplete"),
                            a = i.previous;
                        i.element[0] !== s.activeElement && (i.element.focus(), i.previous = a, setTimeout(function() {
                            i.previous = a, i.selectedItem = n
            ...
            _initSource: function() {
				...
				// var value1 = document.getElementById("firstparemeter").value;
        ...
        t.widget("ui.menu", {
            ...
            activate: function(t, e) {
                if (this.deactivate(), this.hasScroll()) {
                    ...
                    0 > i ? this.element.scrollTop(s + i) : i >= n && this.element.scrollTop(s + i - n + e.height())
                }
        ...
        t.widget("ui.button", {
            ...
            _create: function() {
                ...
                var e = this,
                    ...
                    d = "ui-state-focus";
                null === r.label && (r.label = this.buttonElement.html()), this.buttonElement.addClass(o).attr("role", "button").bind("mouseenter.button", function() {
                    ...
                    return r.disabled || a ? !1 : (t(this).toggleClass("ui-state-active"), void e.buttonElement.attr("aria-pressed", e.element[0].checked))
                    ...
                    return r.disabled ? !1 : (t(this).addClass("ui-state-active"), i = this, t(document).one("mouseup", function() {
                        i = null
                    }), void 0)
            ...
            destroy: function() {
                this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(o + " " + r + " " + l).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title"), t.Widget.prototype.destroy.call(this)
            },
            _setOption: function(e, i) {
            ...
            _resetButton: function() {
                ...
                var e = this.buttonElement.removeClass(l),
                    ...
                    a = [];
                s.primary || s.secondary ? (this.options.text && a.push("ui-button-text-icon" + (n ? "s" : s.primary ? "-primary" : "-secondary")), s.primary && e.prepend("<span class='ui-button-icon-primary ui-icon " + s.primary + "'></span>"), s.secondary && e.append("<span class='ui-button-icon-secondary ui-icon " + s.secondary + "'></span>"), this.options.text || (a.push(n ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || e.attr("title", i))) : a.push("ui-button-text-only"), e.addClass(a.join(" "))
            }
    ...
    function($, undefined) {
        ...
        $.extend(Datepicker.prototype, {
                ...
                if (t = t.target || t, "input" != t.nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                    ...
                    if (s !== !1) {
                        ...
                        if ($.datepicker._pos = null, e.dpDiv.empty(), e.dpDiv.css({
                            ...
                            e.dpDiv.zIndex($(t).zIndex() + 1), $.datepicker._datepickerShowing = !0, $.effects && $.effects[o] ? e.dpDiv.show(o, $.datepicker._get(e, "showOptions"), r, l) : e.dpDiv[o || "show"](o ? r : null, l), (!o || !r) && l(), e.input.is(":visible") && !e.input.is(":disabled") && e.input.focus(), $.datepicker._curInst = e
                        }
                    }
                }
            },
            ...
            _checkOffset: function(t, e, i) {
                ...
                return e.left -= this._get(t, "isRTL") ? s - a : 0, e.left -= i && e.left == t.input.offset().left ? $(document).scrollLeft() : 0, e.top -= i && e.top == t.input.offset().top + o ? $(document).scrollTop() : 0, e.left -= Math.min(e.left, e.left + s > r && r > s ? Math.abs(e.left + s - r) : 0), e.top -= Math.min(e.top, e.top + n > l && l > n ? Math.abs(n + o) : 0), e
            },
            _findPos: function(t) {
            ...
            parseDate: function(t, e, i) {
                ...
                for (var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, a = (i ? i.dayNames : null) || this._defaults.dayNames, o = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, r = (i ? i.monthNames : null) || this._defaults.monthNames, l = -1, h = -1, c = -1, u = -1, d = !1, p = function(e) {
                ...
                if (-1 == l ? l = (new Date).getFullYear() : 100 > l && (l += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (s >= l ? 0 : -100)), u > -1)
                    for (h = 1, c = u;;) {
            ...
            _determineDate: function(t, e, i) {
                var s = function(t) {
                    ...
                    n = function(e) {
                        ...
                        for (var s = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, n = s.getFullYear(), a = s.getMonth(), o = s.getDate(), r = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, l = r.exec(e); l;) {
                            switch (l[2] || "d") {
                                case "d":
                                case "D":
                                    o += parseInt(l[1], 10);
                                ...
                                case "m":
                                case "M":
                                    a += parseInt(l[1], 10), o = Math.min(o, $.datepicker._getDaysInMonth(n, a));
                                    break;
                                case "y":
                                case "Y":
                                    n += parseInt(l[1], 10), o = Math.min(o, $.datepicker._getDaysInMonth(n, a))
                            }
                            l = r.exec(e)
                        }
            ...
            _generateHTML: function(t) {
                ...
                m = a ? this.formatDate(m, this._daylightSavingAdjust(new Date(f, p - l, 1)), this._getFormatConfig(t)) : m;
                ...
                b = a ? this.formatDate(b, this._daylightSavingAdjust(new Date(f, p + l, 1)), this._getFormatConfig(t)) : b;
                ...
                for (var D = this._get(t, "showWeek"), I = this._get(t, "dayNames"), P = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), M = this._get(t, "monthNames"), S = this._get(t, "monthNamesShort"), z = this._get(t, "beforeShowDay"), T = this._get(t, "showOtherMonths"), A = this._get(t, "selectOtherMonths"), H = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), N = "", W = 0; W < o[0]; W++) {
                    ...
                    for (var E = 0; E < o[1]; E++) {
                        var R = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
                            ...
                            Y = "";
                        if (h) {
                            if (Y += '<div class="ui-datepicker-group', o[1] > 1) switch (E) {
                                case 0:
                        ...
                        Y += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + F + '">' + (/all|left/.test(F) && 0 == W ? i ? _ : v : "") + (/all|right/.test(F) && 0 == W ? i ? v : _ : "") + this._generateMonthYearHeader(t, p, f, u, d, W > 0 || E > 0, M, S) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                        for (var L = D ? '<th class="ui-datepicker-week-col">' + this._get(t, "weekHeader") + "</th>" : "", j = 0; 7 > j; j++) {
                            var q = (j + C) % 7;
                        ...
                        this.maxRows = Q;
                        for (var V = this._daylightSavingAdjust(new Date(f, p, 1 - K)), X = 0; Q > X; X++) {
                            Y += "<tr>";
                            for (var Z = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(V) + "</td>" : "", j = 0; 7 > j; j++) {
                                var G = z ? z.apply(t.input ? t.input[0] : null, [V]) : [!0, ""],
                                    J = V.getMonth() != p,
                                    tt = J && !A || !G[0] || u && u > V || d && V > d;
                        ...
                        p++, p > 11 && (p = 0, f++), Y += "</tbody></table>" + (h ? "</div>" + (o[0] > 0 && E == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), O += Y
                    }
                    N += O
                }
                ...
                if (c || (u += d + (!a && l && h ? "" : "&#xa0;")), !t.yearshtml)
                    if (t.yearshtml = "", a || !h) u += '<span class="ui-datepicker-year">' + i + "</span>";
                        ...
                        var m = this._get(t, "yearRange").split(":"),
                            ...
                            _ = b(m[0]),
                            y = Math.max(_, b(m[1] || ""));
                        for (_ = s ? Math.max(_, s.getFullYear()) : _, y = n ? Math.min(y, n.getFullYear()) : y, t.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; y >= _; _++) t.yearshtml += '<option value="' + _ + '"' + (_ == i ? ' selected="selected"' : "") + ">" + _ + "</option>";
        ...
        t.widget("ui.dialog", {
            ...
            _create: function() {
                ...
                var e = this,
                    ...
                    r = (e.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(o), (e.uiDialogTitlebar = t("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(o)),
                ...
                (e.uiDialogTitlebarCloseText = t("<span></span>")).addClass("ui-icon ui-icon-closethick").text(s.closeText).appendTo(l), t("<span></span>").addClass("ui-dialog-title").attr("id", a).html(n).prependTo(r);
                t.isFunction(s.beforeclose) && !t.isFunction(s.beforeClose) && (s.beforeClose = s.beforeclose), r.find("*").add(r).disableSelection(), s.draggable && t.fn.draggable && e._makeDraggable(), s.resizable && t.fn.resizable && e._makeResizable(), e._createButtons(s.buttons), e._isOpen = !1, t.fn.bgiframe && o.bgiframe()
            },
            _init: function() {
            ...
            moveToTop: function(e, i) {
                var s, n = this,
                    a = n.options;
                return a.modal && !e || !a.stack && !a.modal ? n._trigger("focus", i) : (a.zIndex > t.ui.dialog.maxZ && (t.ui.dialog.maxZ = a.zIndex), n.overlay && (t.ui.dialog.maxZ += 1, n.overlay.$el.css("z-index", t.ui.dialog.overlay.maxZ = t.ui.dialog.maxZ)), s = {
            ...
            _makeDraggable: function() {
                ...
                s.uiDialog.draggable({
                    ...
                    start: function(a, o) {
                        i = "auto" === n.height ? "auto" : t(this).height(), t(this).height(t(this).height()).addClass("ui-dialog-dragging"), s._trigger("dragStart", a, e(o))
                    },
                    drag: function(t, i) {
                        s._trigger("drag", t, e(i))
                    },
                    stop: function(o, r) {
                        n.position = [r.position.left - a.scrollLeft(), r.position.top - a.scrollTop()], t(this).removeClass("ui-dialog-dragging").height(i), s._trigger("dragStop", o, e(r)), t.ui.dialog.overlay.resize()
                    }
                })
            },
            ...
            _setOption: function(e, s) {
                ...
                switch (e) {
                    ...
                    case "disabled":
                        ...
                        break;
                    case "draggable":
                        var o = a.is(":data(draggable)");
                        o && !s && a.draggable("destroy"), !o && s && n._makeDraggable();
                        break;
                    case "position":
                        n._position(s);
                        break;
                    case "resizable":
                        var r = a.is(":data(resizable)");
                        r && !s && a.resizable("destroy"), r && "string" == typeof s && a.resizable("option", "handles", s), !r && s !== !1 && n._makeResizable(s);
                        break;
                    case "title":
            ...
            _size: function() {
                ...
                if (this.element.show().css({
                    ...
                    if (t.support.minHeight) this.element.css({
                        ...
                        n || this.uiDialog.hide(), this.element.height(Math.max(a, i))
        ...
        t.fn.position = function(e) {
                ...
                return 9 === u.nodeType ? (r = c.width(), l = c.height(), h = {
                    ...
                    var i, s = t(this),
                        ...
                        v = t.extend({}, h);
                    "right" === e.my[0] ? v.left -= o : e.my[0] === n && (v.left -= o / 2), "bottom" === e.my[1] ? v.top -= c : e.my[1] === n && (v.top -= c / 2), a.fractions || (v.left = Math.round(v.left), v.top = Math.round(v.top)), i = {
                        left: v.left - u,
                        top: v.top - f
                    ...
                    left: function(e, i) {
                        if (i.at[0] !== n) {
                            var s = t(window),
                                ...
                                l = -2 * i.offset[0];
                            e.left += i.collisionPosition.left < 0 ? o + r + l : a > 0 ? o + r + l : 0
                        }
                    },
                    top: function(e, i) {
                        if (i.at[1] !== n) {
                            var s = t(window),
                                ...
                                l = -2 * i.offset[1];
                            e.top += i.collisionPosition.top < 0 ? o + r + l : a > 0 ? o + r + l : 0
                        }
                    }
                }
            ...
            function() {
                ...
                e.appendChild(l), i = r || document.documentElement, i.insertBefore(e, i.firstChild), l.style.cssText = "position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;", n = t(l).offset(function(t, e) {
                    return e
                }).offset(), e.innerHTML = "", i.removeChild(e), o = n.top + n.left + (r ? 2e3 : 0), a.fractions = o > 21 && 22 > o
            }()
    }(jQuery),
    function(t, e) {
    ...
    function(t, e) {
        ...
        t.widget("ui.slider", t.ui.mouse, {
            ...
            _create: function() {
                ...
                for (var l = n.length; o > l; l += 1) r.push(a);
                this.handles = n.add(t(r.join("")).appendTo(e.element)), this.handle = this.handles.eq(0), this.handles.add(this.range).filter("a").click(function(t) {
                    ...
                    var n, a, o, r, l = t(this).data("index.ui-slider-handle");
                    if (!e.options.disabled) {
                        ...
                        switch (r = e.options.step, a = o = e.options.values && e.options.values.length ? e.values(l) : e.value(), s.keyCode) {
                            case t.ui.keyCode.HOME:
                                o = e._valueMin();
                                break;
                            case t.ui.keyCode.END:
                                ...
                                break;
                            case t.ui.keyCode.PAGE_UP:
                                o = e._trimAlignValue(a + (e._valueMax() - e._valueMin()) / i);
                                break;
                            case t.ui.keyCode.PAGE_DOWN:
                                o = e._trimAlignValue(a - (e._valueMax() - e._valueMin()) / i);
                                break;
            ...
            _mouseCapture: function(e) {
                var i, s, n, a, o, r, l, h, c, u = this.options;
                ...
                }), u.range === !0 && this.values(1) === u.min && (r += 1, a = t(this.handles[r])), l = this._start(e, r), l === !1 ? !1 : (this._mouseSliding = !0, o._handleIndex = r, a.addClass("ui-state-active").focus(), h = a.offset(), c = !t(e.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = c ? {
                    left: 0,
                    top: 0
                } : {
            ...
            _refreshValue: function() {
                ...
                }) : (s = this.value(), n = this._valueMin(), a = this._valueMax(), e = a !== n ? (s - n) / (a - n) * 100 : 0, c["horizontal" === l.orientation ? "left" : "bottom"] = e + "%", this.handle.stop(1, 1)[h ? "animate" : "css"](c, r.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({
                    width: e + "%"
    ...
    function(t, e) {
        ...
        t.widget("ui.tabs", {
            ...
            _tabify: function(i) {
                ...
                this.list = this.element.find("ol,ul").eq(0), this.lis = t(" > li:has(a[href])", this.list), this.anchors = this.lis.map(function() {
                    ...
                    var s, r = t(i).attr("href"),
                        l = r.split("#")[0];
                    if (l && (l === location.toString().split("#")[0] || (s = t("base")[0]) && l === s.href) && (r = i.hash, i.href = r), o.test(r)) n.panels = n.panels.add(n.element.find(n._sanitizeSelector(r)));
                    else if (r && "#" !== r) {
                        t.data(i, "href.tabs", r), t.data(i, "load.tabs", r.replace(/#.*$/, ""));
                        var h = n._tabId(i);
                        i.href = "#" + h;
                        var c = n.element.find("#" + h);
                        c.length || (c = t(a.panelTemplate).attr("id", h).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(n.panels[e - 1] || n.list), c.data("destroy.tabs", !0)), n.panels = n.panels.add(c)
                ...
                }), "number" != typeof a.selected && a.cookie && (a.selected = parseInt(n._cookie(), 10)), "number" != typeof a.selected && this.lis.filter(".ui-tabs-selected").length && (a.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))), a.selected = a.selected || (this.lis.length ? 0 : -1)) : null === a.selected && (a.selected = -1), a.selected = a.selected >= 0 && this.anchors[a.selected] || a.selected < 0 ? a.selected : 0, a.disabled = t.unique(a.disabled.concat(t.map(this.lis.filter(".ui-state-disabled"), function(t, e) {
                    return n.lis.index(t)
                }))).sort(), -1 != t.inArray(a.selected, a.disabled) && a.disabled.splice(t.inArray(a.selected, a.disabled), 1), this.panels.addClass("ui-tabs-hide"), this.lis.removeClass("ui-tabs-selected ui-state-active"), a.selected >= 0 && this.anchors.length && (n.element.find(n._sanitizeSelector(n.anchors[a.selected].hash)).removeClass("ui-tabs-hide"), this.lis.eq(a.selected).addClass("ui-tabs-selected ui-state-active"), n.element.queue("tabs", function() {
                ...
                for (var r, l = 0; r = this.lis[l]; l++) t(r)[-1 == t.inArray(l, a.disabled) || t(r).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
                ...
                var u, d;
                a.fx && (t.isArray(a.fx) ? (u = a.fx[0], d = a.fx[1]) : u = d = a.fx);
                var p = d ? function(e, i) {
                        t(e).closest("li").addClass("ui-tabs-selected ui-state-active"), i.hide().removeClass("ui-tabs-hide").animate(d, d.duration || "normal", function() {
                            s(i, d), n._trigger("show", null, n._ui(e, i[0]))
                        })
                    } : function(e, i) {
                        t(e).closest("li").addClass("ui-tabs-selected ui-state-active"), i.removeClass("ui-tabs-hide"), n._trigger("show", null, n._ui(e, i[0]))
                    },
                    f = u ? function(t, e) {
                        e.animate(u, u.duration || "normal", function() {
                            n.lis.removeClass("ui-tabs-selected ui-state-active"), e.addClass("ui-tabs-hide"), s(e, u), n.element.dequeue("tabs")
                        })
                    } : function(t, e, i) {
                ...
                this.anchors.bind(a.event + ".tabs", function() {
                    var e = this,
                        ...
                        o = n.element.find(n._sanitizeSelector(e.hash));
            ...
            add: function(i, s, n) {
                ...
                var a = this,
                    o = this.options,
                    r = t(o.tabTemplate.replace(/#\{href\}/g, i).replace(/#\{label\}/g, s)),
                ...
                return h.length || (h = t(o.panelTemplate).attr("id", l).data("destroy.tabs", !0)), h.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"), n >= this.lis.length ? (r.appendTo(this.list), h.appendTo(this.list[0].parentNode)) : (r.insertBefore(this.lis[n]), h.insertBefore(this.panels[n])), o.disabled = t.map(o.disabled, function(t, e) {
                    return t >= n ? ++t : t
                }), this._tabify(), 1 == this.anchors.length && (o.selected = 0, r.addClass("ui-tabs-selected ui-state-active"), h.removeClass("ui-tabs-hide"), this.element.queue("tabs", function() {
            ...
            load: function(e) {
                ...
                if (this.abort(), !a || 0 !== this.element.queue("tabs").length && t.data(n, "cache.tabs")) return void this.element.dequeue("tabs");
                ...
                return this.xhr = t.ajax(t.extend({}, s.ajaxOptions, {
                    ...
                    success: function(a, o) {
                        i.element.find(i._sanitizeSelector(n.hash)).html(a), i._cleanup(), s.cache && t.data(n, "cache.tabs", !0), i._trigger("load", null, i._ui(i.anchors[e], i.panels[e]));
                        try {
            ...
            rotate: function(t, e) {
                ...
                return t ? (this.element.bind("tabsshow", n), this.anchors.bind(s.event + ".tabs", a), n()) : (clearTimeout(i.rotation), this.element.unbind("tabsshow", n), this.anchors.unbind(s.event + ".tabs", a), delete this._rotate, delete this._unrotate), this
            }
        })
    }(jQuery);