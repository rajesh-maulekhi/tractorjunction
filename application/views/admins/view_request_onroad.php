...
-->
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 "
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
                <h3>Show On Road Price Request</h3>
                ...
                <table border="0" style="width:100%;" class="table table-striped">
					...
					echo $obj->model;
                            ...
                            <td><?php echo $obj->date_; ?></td>
							    <td>
                                <a href="<?php echo $root ?>admins/DeleteReply_request_onroad?id=<?php echo $obj->id; ?>"><i
...
<?php } ?>
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <!--
<a href="<?php echo $root ?>admins/Reply_request_onroad?id=<?php echo $obj->id; ?>"><i class="fa fa-reply"> </i></a>
-->
                            </td>
