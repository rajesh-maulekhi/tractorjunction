...
if ($this->session->userdata('admin')) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
            ...
            <div class="col-sm-2 col-md-2">
                <a href="add_brand">
                    <button type="button" class="btn btn-default buttoupdate" style="" id="">Add Brand</button>
                </a>
            </div>
            ...
            <div class="col-sm-3 col-md-3" style="float:right;">
                <?php echo form_input(array('type' => 'text', 'id' => 'search_box', 'name' => 'search_box_name', 'placeholder' => 'Brand Name', 'class' => 'form-control', 'style' => 'height:37px;border-radius:0px;margin-left:87px')); ?>
...
height:auto;
    ...
    color: #139ED9 !important;" class="checkbox" value="<?php echo $obj->id; ?>"/></td>
                        ...
                        <td><?php
                            echo substr(ucfirst(strtolower($obj->description)), 0, 20) . "...";

                            ?></td>
                        <td>
                            <?php echo form_open('admins/edit_brand'); ?>
                            ...
                            <button type="button" class="btn btn-default buttoupdate" value="<?php echo $obj->id; ?>"
                                    id="<?php echo $obj->image; ?>" onclick="delete_tractor(this.value,this.id);"
                                    style=""><i class="fa fa-times"> Delete</i></button>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function delete_tractor(k, image) {

            var val_tractor = k;
            document.getElementById('gif_image').style.display = "block";
            $.ajax({
                type: "POST",
                url: '../admins/delete_brand_single',
                data: {val21: val_tractor, img: image},
                success: function (data) {
                    alert(data);
                    document.getElementById('gif_image').style.display = "none";
                    location.reload();
        ...
        function search_re() {
            ...
            $.ajax({
                type: "POST",
                url: '../admins/search_brand_result',
