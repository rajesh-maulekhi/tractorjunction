...
if ($this->session->userdata('admin')) {
    ...
    <title>Admin || View Dealers </title>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
            ...
            <div class="col-sm-2 col-md-2">
                <a href="add_dealers">
                    <button type="button" class="btn btn-default buttoupdate" style="" id="delete">Add Dealers</button>
                </a>
            </div>
            ...
            <div class="col-sm-3 col-md-3" style="float:right;">
                <?php echo form_input(array('type' => 'text', 'id' => 'search_box', 'name' => 'search_box_name', 'autocomplete' => 'off', 'placeholder' => 'Pin / City Name', 'class' => 'form-control', 'style' => 'height:37px;border-radius:0px;margin-left:87px')); ?>
...
height:auto;
    ...
    color: #139ED9 !important;" class="checkbox" value="<?php echo $obj->id; ?>"/></td>
                        ...
                        <td><?php echo ucfirst($obj->name_de); ?></td>

                        <td style="width:10%;"><?php

                            foreach (shweta_select('name', 'brand', 'id', $obj->authorize) as $raa1) echo $raa1->name;
                            ?>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function delete_tractor(k) {
            ...
            $.ajax({
                type: "POST",
                url: '../admins/delete_dealers_single',
        ...
        $("#search_box").keyup(function (event) {
            ...
            if (value != "") {
                $.ajax({
                    type: "POST",
                    url: '../admins/search_dealers_name',
        ...
        function search_re() {
            ...
            $.ajax({
                type: "POST",
                url: '../admins/search_dealers_result',
