...
if ($this->session->userdata('admin')) {
    ...
    <title>Admin || Show new Implement </title>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
        <a href="<?php echo $root; ?>admins/add-implement">
            <button type="button" class="btn btn-default buttoupdate" style="">Add Implement</button>
        </a>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 "
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
            <div class="col-md-3">
                <h3>Implements List</h3>
            </div>
            <div class="col-md-9">
                <div class="col-md-9">

                    <?php echo form_open('admins/show-implement-list'); ?>
                    <?php echo form_input(array('type' => 'text', 'name' => 'name', 'id' => 'ImplementNameDiv', 'placeholder' => 'Enter model Name', 'required' => 'required', 'class' => 'form-control')); ?>
                </div>
                <div class="col-md-3">
            ...
            if (isset($_POST['submitbt'])) {
                ...
                $result = shweta_pagination_query_new_orderby('new_implement', '9', 'admins/show-implement-list', $condition, 'id', 'DESC');
            } else {
                $condition = '';
                $result = shweta_pagination_query_new_orderby('new_implement', '9', 'admins/show-implement-list', $condition, 'id', 'DESC');
            }
            ...
            <?php } else { ?>
                <table id="keywords" class="table table-striped" style="cursor:pointer;" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <th style="width:10%;">Implement type</th>
                        <th style="width:10%;">Implement Category</th>
                    ...
                    foreach ($result['result'] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?php echo ucfirst($value->model_name); ?></td>
                            <td>
                            ...
                            <td><?php foreach (shweta_select('name', 'filed', 'id', $value->implementType) as $raa) echo ucfirst($raa->name); ?></td>
                            <td><?php foreach (shweta_select('name', 'implement_type_cate', 'id', $value->implement_cate) as $raa) echo ucfirst($raa->name); ?></td>


                            <td><?php echo $value->date; ?></td>
                            <td>
                                <a target="_blank" title="Edit"
                                   href="<?php echo $root; ?>admins/edit-implement-new/<?php echo $value->id; ?>">
                                    <button type="button" style="background:#065E84;color:#eee;"
                                            class="ap btn btn-default"><i class="fa fa-edit"></i></button>
                                </a>
                                <a title="Delete"
                                   href="<?php echo $root; ?>admins/ImplementTractor/deleteImplementNew/<?php echo $value->id; ?>">
