...
if ($this->session->userdata('admin')) {
    ?>
    <title>Admin || Single purchase Implement tractor </title>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding: 30px 15px;background: #fff;">
            <h3>Details Purachse implement tractor</h3>
                        ...
                        <div class="col-md-12 col-sm-12" style="margin: auto;float: none;font-size: 21px;">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-6 l2">
                                    <?php
                                    $model_name = '';
                                    foreach (shweta_select('brand,model_name,slug', 'old_implement', 'id', $obj->requestfor) as $raa) {
                        ...
                        <div class="col-md-12 col-sm-12" style="margin: auto;float: none;font-size: 21px;">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-6 l2">
                                    <?php
                                    $slug = "";
                                    foreach (shweta_select('slug', 'old_implement', 'id', $obj->requestfor) as $raa) $slug = ($raa->slug);
                                    ...
                                    <a href="<?php echo $root; ?>used-tractor-implement/<?php echo newslugend($brand); ?>-<?php echo newslugend($model_name); ?>"
                                       target="_blank">
                                        ...
                                        <?php
                                        foreach (shweta_select('model_name', 'old_implement', 'id', $obj->requestfor) as $raa) {
                                            echo $raa->model_name;
