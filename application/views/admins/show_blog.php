    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
            ...
            <div class="col-sm-2 col-md-2">
                <a href="<?php echo $root; ?>admins/Blog">
                    <button type="button" class="btn btn-default buttoupdate" style="" id="delete">Add Blog</button>
                </a>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
                ...
                <table border="0" style="width:100%;" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php echo $s_no; ?>.</td>
						       <td>
						<img src="<?php echo $root; ?>upload/blog_image/<?php echo $obj->image_name; ?>" style="height: 50px;
border: 1px solid #ddd;
padding: 5px;
">
						</td>
                        <td><?php echo ucfirst($obj->title); ?></td>
                 
                        <td><?php echo ucfirst($obj->blog_date); ?></td>
                        <td>
					<a href="<?php echo $root; ?>admins/Blog/EditBlog/<?php echo $obj->id;?>">
                                    <button class="btn btn-default buttoupdate">Edit</button>
                                </a>
					<a href="<?php echo $root; ?>admins/Blog/DeleteBlog/<?php echo $obj->id;?>" onclick="return dialogeBox();">
