...
if ($this->session->userdata('admin')) {
    ...
    <title>Admin || Show Dealership Enquiry </title>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 "
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
            ...
            $result = array();
            $condition = '';
            $result = shweta_pagination_query_new_orderby('dealership_enquiry', '9', 'admins/list-Dealership-enquiry', $condition, 'id', 'DESC');
            // echo "<pre>";
            // print_r($result);
            // die;
            ...
            <?php } else { ?>
                <table id="keywords" class="table table-striped" style="cursor:pointer;" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <th style="width:15%;">Customer Email-id</th>
                        <th style="width:15%;">Customer Contact no</th>
                        <th style="width:15%;">Request for brand</th>
                    ...
                    foreach ($result['result'] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?php foreach (shweta_select('name', 'brand', 'id', $value->brand) as $raa) echo ucfirst($raa->name);
                            ...
                            <td>
                                <a title="view"
                                   href="<?php echo $root; ?>admins/view-dealership-tractor/<?php echo $value->id; ?>">
                                ...
                                if ($value->status == 1) {
                                    ...
                                    <a title="click to don't want to reply"
                                       href="<?php echo $root; ?>admins/ListDealershipEnquiry/inactive/<?php echo $value->id; ?>/0">
                                    ...
                                    <a title="click to reply confirmed"
                                       href="<?php echo $root; ?>admins/ListDealershipEnquiry/inactive/<?php echo $value->id; ?>/1">
