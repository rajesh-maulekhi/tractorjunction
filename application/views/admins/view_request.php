                ...
                <table border="0" style="width:100%;" class="table table-striped">
                    ...
                    foreach ($result as $row => $obj) {
                        ...
                        <tr style="text-align: left;">
                            ...
                            <td>
                                <a href="<?php echo $root; ?>admins/View_demo_request?id=<?php echo $obj->id; ?>"><i
                                            class="fa fa-eye"></i></a>
                                &nbsp;&nbsp;&nbsp;
                                <a href="<?php echo $root; ?>admins/Reply_request?id=<?php echo $obj->id; ?>"><i
                                            class="fa fa-reply"> </i></a>
                                &nbsp;&nbsp;&nbsp;
                                <a href="<?php echo $root; ?>admins/DeleteReply_request?id=<?php echo $obj->id; ?>"> <i
