                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12" style="margin: auto;float: none;font-size: 21px;">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-6 l2">
                                    <a title="View Tractor"
                                       href="<?php echo $root; ?>used-tractor/<?php foreach (shweta_select('name', 'brand', 'id', $obj->brand) as $raa) echo newslugend($raa->name); ?>-<?php echo newslugend($obj->model_name); ?>"
                                       target="_blank">
