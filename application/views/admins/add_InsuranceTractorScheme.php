...
if ($this->session->userdata('admin')) {
    ?>
    <title>Admin || Add insurance scheme </title>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding: 30px 15px;background: #fff;">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    echo form_open_multipart('admins/ListInsuranceTractor/schemeEnd', $att); ?>
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo form_input(array('type' => 'text', 'name' => 'order_by', 'placeholder' => 'Enter order_by', 'required' => 'required', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                    </div>
                    <div class="form-group">
          ...
          required="">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                            <?php echo form_input(array('type' => 'submit', 'id' => 'form_up', 'class' => 'btn btn-default buttoupdate', 'value' => 'Add')); ?>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
