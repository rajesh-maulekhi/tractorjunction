...
if ($this->session->userdata('admin')) {
    ...
    <title>Admin || Implement tarctor List </title>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 "
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
            <h3>Implement tractor purchase details
            </h3>

            <hr style="  border-top: 3px solid #C5C2C2;">
            <?php
            $result = array();
            $condition = "type='implement'";
            $result = shweta_pagination_query_new_orderby('purchaserequest', '9', 'admins/buy-rent-tractors-details', $condition, 'id', 'DESC');
            // echo "<pre>";
            // print_r($result);
            // die;
                ...
                <table id="keywords" class="table table-striped" style="cursor:pointer;" cellspacing="0"
                    ...
                    foreach ($result['result'] as $key => $value) {
                        ...
                        <tr>
                            <?php
                            $model_name = '';
                            foreach (shweta_select('brand,model_name,slug', 'old_implement', 'id', $value->requestfor) as $raa) {
                            ...
                            <td>
                                ...
                                <a href="<?php echo $root; ?>used-tractor-implement/<?php echo newslugend($brand); ?>-<?php echo newslugend($model_name); ?>"
                                   target="_blank">
                            ...
                            <td>
                                <a title="View Order"
                                   href="<?php echo $root; ?>admins/view-implement-tractor-purchase-details/<?php echo $value->id; ?>">
                                    <button type="button" style="background:#1ABB9C;color:#eee;"
                                            class="ap btn btn-default"><i class="fa fa-eye"></i>
                                        View Order
                                    </button>
                                </a>
