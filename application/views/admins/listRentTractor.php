...
if ($this->session->userdata('admin')) {
    ...
    <title>Admin || Show Rent tractor </title>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
            ...
            <div class="col-md-9">
                <div class="col-md-9">
                    ...
                    <?php echo form_open('admins/list-rent-tractors'); ?>
                    <?php echo form_input(array('type' => 'text', 'name' => 'name', 'id' => 'RentTractorName', 'placeholder' => 'Enter Tractor Name', 'required' => 'required', 'class' => 'form-control')); ?>
                </div>
                <div class="col-md-3">
            ...
            if (isset($_POST['submitbt'])) {
                ...
                $result = shweta_pagination_query_new_orderby('rent_tractor', '9', 'admins/list-rent-tractors', $condition, 'id', 'DESC');
            } else {
                $condition = '';
                $result = shweta_pagination_query_new_orderby('rent_tractor', '9', 'admins/list-rent-tractors', $condition, 'id', 'DESC');
            }
                ...
                <table id="keywords" class="table table-striped" style="cursor:pointer;" cellspacing="0"
                    ...
                    foreach ($result['result'] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $i; ?></td>
                            <td><?php echo ucfirst(str_replace('-', ' ', $value->rent_type)); ?></td>
                            ...
                            <td><?php echo ucwords($value->availability_val); ?></td>


                            <td>
                                <a title="View Info"
                                   href="<?php echo $root; ?>admins/view-rent-tractor/<?php echo $value->id; ?>">
