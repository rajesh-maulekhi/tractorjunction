...
if ($this->session->userdata('admin')) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;"><a
                ...
                <button type="button" class="btn btn-default buttoupdate" style="">Show Newsletter user's list</button>
            </a>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding: 30px 15px;background: #fff;">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    echo form_open_multipart('admins/ShowNewsletterUsers/addNewsletterEnd', $att); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo form_input(array('type' => 'text', 'name' => 'title', 'id' => 'model_name', 'placeholder' => 'Title', 'required' => 'required', 'class' => 'form-control col-md-7 col-xs-12')); ?>
                        </div>
                    </div>
...
<textarea name="des" placeholder="Please add description" class="form-control col-md-7 col-xs-12 ckeditor" required="">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                            <?php echo form_input(array('type' => 'submit', 'id' => 'form_up', 'class' => 'btn btn-default buttoupdate', 'value' => 'Send Message')); ?>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
