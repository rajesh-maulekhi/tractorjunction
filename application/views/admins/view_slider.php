...
if ($this->session->userdata('admin')) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
            ...
            <div class="col-sm-2 col-md-2">
                <a href="add_slider">
                    <button type="button" class="btn btn-default buttoupdate" style="" id="delete">Add Slider</button>
                </a>
            </div>
...
height:auto;
    ...
    color: #139ED9 !important;" class="checkbox" value="<?php echo $obj->id; ?>"/></td>
                        ...
                        <td><?php echo $s_no; ?>.</td>
                        <td><?php echo $obj->slider_caption; ?></td>
                        <td style="width:20%;"><?php

                            $cou = strlen($obj->slider_sub_caption);
                            if ($cou > 5) {
                                echo substr($obj->slider_sub_caption, 0, 10); ?>.......
                            <?php } else
                                echo ucfirst($obj->slider_sub_caption);
                            ?>
                        </td>
                        ...
                        <td style="width:20%;"><?php
                            ...
                            $cou = strlen($obj->read_link);
                            if ($cou > 5) {
                                echo substr($obj->read_link, 0, 10); ?>.......
                            <?php } else
                                echo ucfirst($obj->read_link);
                            ?>
                        </td>

                        <td>
                            <?php echo form_open('admins/edit_slider'); ?>
    ...
    <script type="text/javascript">
        ...
        function delete_tractor(k) {
            ...
            $.ajax({
                type: "POST",
                url: '../admins/delete_slider_single',
