...
if ($this->session->userdata('admin')) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
        <div class="col-sm-2 col-md-2">
            <a href="<?php echo $root; ?>admins/newsletter">
                <button type="button" class="btn btn-default buttoupdate" style="" id="delete">Newsletter</button>
            </a>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 "
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
            <h3>Show NewsLetter </h3>

            <hr style="  border-top: 3px solid #C5C2C2;">
            <?php
            $result = array();
            $condition = '';
            $result = shweta_pagination_query_new_orderby('newsleter', '9', 'admins/show-newsletter-users', $condition, 'id', 'DESC');
            // echo "<pre>";
            // print_r($result);
            // die;
                ...
                <table class="table table-striped">
                    ...
                    foreach ($result['result'] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?php
                                if ($value->status == 0) {
                                    ?><span style="color:#D43F3A;">Activation pending</span><?php
                                } else {
                                    ?><span style="color:#5BA829;">Activated</span><?php
                                }
                                ?></td>
                            <td><?php
                                if ($value->status == 0) {
                                    ...
                                    ?>
                                    <a title="unsubscribe"
                                       href="<?php echo $root; ?>admins/unsubscribe-users/<?php echo $value->id; ?>">
                                        <button style="background:#D43F3A;color:#eee;" type="button"
                                                class="ap btn btn-default">Click here to unsubscribe
                                        </button>
                                    </a>
