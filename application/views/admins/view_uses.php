...
if ($this->session->userdata('admin')) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:20px 14px;">
            ...
            <div class="col-sm-2 col-md-2">
                <a href="add_uses">
                    <button type="button" class="btn btn-default buttoupdate" style="" id="delete">Add Uses Of Tractor
                    </button>
                </a>
            </div>
            ...
            <div class="col-sm-3 col-md-3" style="float:right;">
                <?php echo form_input(array('type' => 'text', 'id' => 'search_box', 'name' => 'search_box_name', 'placeholder' => 'Category Name', 'class' => 'form-control', 'style' => 'height:37px;border-radius:0px;margin-left:87px')); ?>
