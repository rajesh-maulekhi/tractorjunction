...
if ($this->session->userdata('admin')) {
    ...
    <title>Admin || Rent tarctor List </title>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 "
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="padding:0px; padding-top:0px;">
            <h3>Rent tractor purchase details
            </h3>
                ...
                <table id="keywords" class="table table-striped" style="cursor:pointer;" cellspacing="0"
                    ...
                    foreach ($result['result'] as $key => $value) {
                        ...
                        <tr>
                            <?php
                            $model_name = '';
                            foreach (shweta_select('brand,model_name,slug', 'rent_tractor', 'id', $value->requestfor) as $raa) {
                            ...
                            <td>
                                ...
                                <a href="<?php echo $root; ?>rent-tractor/<?php echo newslugend($model_name); ?>"
                                   target="_blank">
                            ...
                            <td>
                                <a title="View Order"
                                   href="<?php echo $root; ?>admins/view-rent-tractor-purchase-details/<?php echo $value->id; ?>">
