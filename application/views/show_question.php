...
<p class="QuestAG">Ask a Question </p>
<?php echo form_open('Questions/AddQuestionEnd'); ?>
...
<button type="submit" class="AnswwrBT PostQUE">Post Question</button>
</div>
<?php 
if(!empty($result)){
...
<div class="col-md-12 col-sm-12 col-xs-12 paddingZ BUttonQuestion">
<a href="<?php echo $root; ?>post-answer/<?php echo $value->id; ?>/<?php echo newslug_end($value->question); ?>" class="AnswwrBT marPOSTbt"><span class="AnswerNO"><?php echo $this->Front_model->get_answerOFquestion($value->id); ?></span>Answer</a>

<a href="<?php echo $root; ?>post-answer/<?php echo $value->id; ?>/<?php echo newslug_end($value->question); ?>" class="AnswwrBT PostQUE postANS">Post Answer</a>
</div>
</div>
		<?php 
	}
